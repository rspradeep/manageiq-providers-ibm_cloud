class ManageIQ::Providers::IbmCloudVirtualServers::CloudManager::MetricsCapture < ManageIQ::Providers::BaseManager::MetricsCapture
  VIM_STYLE_COUNTERS = {
  ...
  def perf_collect_metrics(interval_name, start_time = nil, end_time = nil)
    ...
    rescue Exception => err # FIXME: perhaps we should be better using 'StandardException' here
