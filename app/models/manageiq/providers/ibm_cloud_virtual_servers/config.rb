module ManageIQ::Providers::IbmCloudVirtualServers::Config
  IC_SERVICE_DESC = "IBM Power Systems Virtual Server".freeze
  IC_SERVICE_DESC_NOSPACES = "ibm_cloud_virtual_servers".freeze # used for image file prefixes
